  ...
  ("multiplayer_escape_menu", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$g_presentation_obj_escape_menu_adimi_features", -1),
      (try_begin),
      ...
      (try_begin),
        (ge, ":my_player_no", 0),
		(this_or_next|player_slot_eq,":my_player_no",adimi_tool_admin_level_low,1),
	    (this_or_next|player_slot_eq,":my_player_no",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":my_player_no",adimi_tool_admin_level_high,1),
        ...
        (create_button_overlay, "$g_presentation_obj_escape_menu_adimi_features", "str_adimi", 0),#adimi tools
        (overlay_set_color, "$g_presentation_obj_escape_menu_adimi_features", red),
      (try_end),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (else_try),
        ...
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_obj_escape_menu_adimi_features"),
        (presentation_set_duration, 0),
        (start_presentation, "prsnt_adimi_features"),
      (else_try),
  ...
  ("multiplayer_poll_menu", prsntf_manual_end_only, 0, [
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (assign, "$adimi_tool_all_button", -1),
      (assign, ":team_rows", 0),
      (assign, ":spectator_rows", 0),
      (get_max_players, ":num_players"),
    ...
    (try_begin),
      (call_script,"script_cf_adimi_tool_presentation_player_list_no_all_button"),
      (try_begin),
        (multiplayer_get_my_player,":adminpid"),
		(player_is_active, ":adminpid"),
	    (this_or_next|player_slot_eq,":adminpid",adimi_tool_admin_level_low,1),
	    (this_or_next|player_slot_eq,":adminpid",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":adminpid",adimi_tool_admin_level_high,1),
        (player_is_admin, ":adminpid"),
        (create_button_overlay, "$adimi_tool_all_button", "str_adimi_tool_all_button", 0),
        (overlay_set_color, "$adimi_tool_all_button", red),
        (position_set_x, pos1, 750),
        (position_set_y, pos1, 750),
        (overlay_set_size, "$adimi_tool_all_button", pos1),
        (position_set_x, pos1, ":cur_x"),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$adimi_tool_all_button", pos1),
      (try_end),
      (try_begin),
        (create_mesh_overlay, reg0, "mesh_white_plane"),
        (overlay_set_color, reg0, 0xFFFFFF),
        ...
        (overlay_set_size, reg0, pos1),
      (try_end),
        (val_sub, ":cur_y", 30),#Adimi Tools All/Everyone Button
        (assign,"$adimi_tool_spawn_selected_player_id",-1),
    (try_end),  
      ...
      (try_for_range, ":unused", 0, ":end_cond"),
        ...
        (try_begin),
          ...
          (str_store_player_username, s1, ":max_kills_player_no"),
          (try_begin),
		    (player_is_active,":max_kills_player_no"),
		    (player_slot_eq, ":max_kills_player_no", slot_player_is_streamer, 1),
		    (str_store_string, s1, "str_adimi_anti_no_name_streamer"),
		  (else_try),
		    (str_store_string, s1, "str_adimi_anti_no_name"),
		  (try_end),
          ...
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
          (player_set_slot, ":max_kills_player_no", slot_player_button_index, reg0),
      ...
      (try_begin),
        ...
        (try_for_range, ":player_no", 0, ":end_cond"),
          ...
          (position_set_y, pos1, ":cur_y"),
          (overlay_set_position, reg0, pos1),
          (player_set_slot, ":player_no", slot_player_button_index, reg0),
     ...
     (try_begin),
	  (set_container_overlay, -1),
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 4),#Admin ban
      (eq, "$g_multiplayer_players_list_action_type", 7),#mute
      ...
      (assign, ":cur_y", 490),
      (create_combo_button_overlay, "$adimi_tool_player_punishment_reason"),
      (call_script,"script_adimi_tool_choose_punishment"),
	  (assign,"$adimi_tool_player_punishment_reason_number",0),#Reset it always to No reason
      (overlay_set_val, "$adimi_tool_player_punishment_reason", "$adimi_tool_player_punishment_reason_number"),#adimi_tool_player_punishment_reason_number is the variable
      (position_set_x, pos1, 800),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$adimi_tool_player_punishment_reason", pos1),
      (position_set_x, pos1, 800),
      (position_set_y, pos1, 1000),
      (overlay_set_size, "$adimi_tool_player_punishment_reason", pos1),
	  
	  (create_text_overlay, reg0, "str_adimi_reason"),
	  (position_set_x, pos1, 700),
	 ...
	 (try_begin),
	  (set_container_overlay, -1),
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 9),#slay
    ...
    (try_begin),
      #Displaying the typ of the operation
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 7), #mute
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 4), #admin ban
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 12),#immortal
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 8),#set hp
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 14),#ammo and shield
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 15),#Switch teams
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 16),#Teleport
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 17),#Teleport
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 18),#freeze
      (eq, "$g_multiplayer_players_list_action_type", 10),#Set gold   
      (set_container_overlay, -1),
      (create_mesh_overlay, reg0, "mesh_mp_ingame_menu"),
      (position_set_x, pos1, 680),
      (position_set_y, pos1, 625),
      ...
      (val_add, ":cur_y", escape_menu_item_height),
      (try_begin),
       (eq, "$g_multiplayer_players_list_action_type", 4),#ban
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_ban"),
      (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 7),#mute
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_mute"),
      (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 10),#gold
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_gold"),
      (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 12),#immortal
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_immortal"),
      (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 8),#Set Hitpoints
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_sethp"),
	  (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 14),#ammo and shield
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_ammoshield"),
	  (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 15),#Switch teams
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_switchteam"),
	  (else_try),
       (this_or_next|eq, "$g_multiplayer_players_list_action_type", 16),#Teleport
       (eq, "$g_multiplayer_players_list_action_type", 17),#Teleport
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_teleport"),
	  (else_try),
       (eq, "$g_multiplayer_players_list_action_type", 18),#freeze
       (create_text_overlay, "$adimi_tool_player_list_text", "str_adimi_tool_player_list_typ_freeze"),
      (try_end),
      (overlay_set_color, "$adimi_tool_player_list_text", 0xFFFFFF),
      (position_set_x, pos1, 688),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$adimi_tool_player_list_text", pos1),
      (position_set_x, pos1, 850),
      (position_set_y, pos1, 850),
      (overlay_set_size, "$adimi_tool_player_list_text", pos1),
      
     (try_begin),
      (neq, "$g_multiplayer_players_list_action_type", 10),#It mustn't be the gold!
      (neq, "$g_multiplayer_players_list_action_type", 8),#It mustn't be the HitPoints bar
      (assign, ":cur_y", 550),
      (val_add, ":cur_y", escape_menu_item_height),
      (create_combo_button_overlay, "$adimi_tool_player_list_0_or_1"),
      (call_script,"script_adimi_tool_presentation_player_list_0_or_1"),
      (overlay_set_val, "$adimi_tool_player_list_0_or_1", "$adimi_tool_show_players_0_or_1"),
      (position_set_x, pos1, 800),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$adimi_tool_player_list_0_or_1", pos1),
      (position_set_x, pos1, 800),
      (position_set_y, pos1, 1000),
      (overlay_set_size, "$adimi_tool_player_list_0_or_1", pos1),
     (try_end),
	 
     (try_begin),
      (this_or_next|eq, "$g_multiplayer_players_list_action_type", 10),#It must be the gold! number box
      (eq, "$g_multiplayer_players_list_action_type", 8),#HitPoints
      (try_begin),
        (eq, "$g_multiplayer_players_list_action_type", 8),#HitPoints
        (create_number_box_overlay, "$g_presentation_adimi_set_value_bar", 1, 101), #returns overlay id
        (overlay_set_val, "$g_presentation_adimi_set_value_bar", "$adimi_tool_set_hp"),
      (else_try),
        (eq, "$g_multiplayer_players_list_action_type", 10),#It must be the gold! number box
        (create_number_box_overlay, "$g_presentation_adimi_set_value_bar", 0, 100001), #Gold click bar
        (overlay_set_val, "$g_presentation_adimi_set_value_bar", "$adimi_tool_set_gold"),
      (try_end),
      (assign, ":cur_y", 592+escape_menu_item_height),
      (position_set_x, pos1, 800),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, "$g_presentation_adimi_set_value_bar", pos1),
     (try_end),#It must be the gold! number box 
    (try_end),  
      (presentation_set_duration, 999999),
      ]),
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      ...
      (try_for_range, ":player_no", 1, ":num_players"), #0 is server no need to write it
        (neq,"$adimi_tool_player_list_0_or_1",":object"),
        (try_begin),
		    (neq,":object","$adimi_tool_all_button"),
		    (player_is_active, ":player_no"),
			(player_slot_eq, ":player_no", slot_player_button_index, ":object"),
			(assign,":continue",1),
	    (else_try),
			(eq,":object","$adimi_tool_all_button"),
            (assign,":continue",1),
        (try_end),
        (try_begin),
        (eq,":continue",1),
        ...
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 3), #admin kick
          (multiplayer_send_2_int_to_server, multiplayer_event_admin_kick_player, ":player_no","$adimi_tool_player_punishment_reason_number"),
          (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
        (else_try),
		  ...
		  (try_begin),
		    ...
		    (player_is_admin, ":p"),
            (multiplayer_send_3_int_to_server, multiplayer_event_admin_ban_player, ":player_no","$adimi_tool_show_players_0_or_1","$adimi_tool_player_punishment_reason_number"),
		  (else_try),
		    (player_slot_eq,":p",adimi_tool_admin_level_low,1),
            (multiplayer_send_3_int_to_server, multiplayer_event_admin_ban_player, ":player_no",1),
		  (try_end),
          (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
        (else_try),
        ...
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 8), #Set HP ADIMI TOOLS
          (try_begin),
           (eq,":object","$adimi_tool_all_button"),
           (multiplayer_send_2_int_to_server, adimi_tool_server_all_event, adimi_tool_heal,"$adimi_tool_set_hp"),
           (presentation_set_duration, 0),
          (else_try),
           (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_heal,":player_no","$adimi_tool_set_hp"),
           (presentation_set_duration, 0),
           (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 9), #Kill a player
          (try_begin),
           (eq,":object","$adimi_tool_all_button"),
           (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_kill,),
          (else_try),
           (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_kill,":player_no","$adimi_tool_player_punishment_reason_number"),
          (try_end),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 10), #Set Gold
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event, adimi_tool_gold,"$adimi_tool_set_gold"),
            (presentation_set_duration, 0),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_gold,":player_no","$adimi_tool_set_gold"),
            (presentation_set_duration, 0),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),    
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 11), #Spawn Item/horse
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (assign,"$adimi_tool_spawn_selected_player_id",50000),
			(assign,"$adimi_tool_for_a_player",2),#2 = all
          (else_try),
            (assign,"$adimi_tool_spawn_selected_player_id",":player_no"),
			(display_message,"@Selected a player"),
			(assign,"$adimi_tool_for_a_player",1),#1=a player
          (try_end),
          (presentation_set_duration, 0),
          (start_presentation, "prsnt_adimi_tool_spawn_items"),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 7), #MUTE
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_mute,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_4_int_to_server, adimi_tool_server_event,adimi_tool_mute, ":player_no","$adimi_tool_show_players_0_or_1","$adimi_tool_player_punishment_reason_number"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 12), #immortal
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_godmode,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event,adimi_tool_godmode, ":player_no","$adimi_tool_show_players_0_or_1"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
        (else_try),
          (eq, "$g_multiplayer_players_list_action_type", 13), #print gameids
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_int_to_server, adimi_tool_server_all_event,adimi_tool_gameid),
          (else_try),
            (multiplayer_send_2_int_to_server, adimi_tool_server_event,adimi_tool_gameid, ":player_no"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (eq, "$g_multiplayer_players_list_action_type", 14), #Ammo and Shield
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_restore_ammo_shield,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event,adimi_tool_restore_ammo_shield, ":player_no","$adimi_tool_show_players_0_or_1"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (eq, "$g_multiplayer_players_list_action_type", 15), #Switch Team
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_switch_team,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event,adimi_tool_switch_team, ":player_no","$adimi_tool_show_players_0_or_1"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (this_or_next|eq, "$g_multiplayer_players_list_action_type", 16), #Teleport
          (eq, "$g_multiplayer_players_list_action_type", 17),
          (try_begin),
		    (neq, "$g_multiplayer_players_list_action_type", 17),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_teleport,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event,adimi_tool_teleport,":player_no","$adimi_tool_show_players_0_or_1"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (eq, "$g_multiplayer_players_list_action_type", 18),
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event,adimi_tool_freeze,"$adimi_tool_show_players_0_or_1"),
          (else_try),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event,adimi_tool_freeze,":player_no","$adimi_tool_show_players_0_or_1"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (eq, "$g_multiplayer_players_list_action_type", 19),
          (try_begin),
            (eq,":object","$adimi_tool_all_button"),
            (multiplayer_send_int_to_server, adimi_tool_server_all_event,adimi_tool_total_fix),
          (else_try),
            (multiplayer_send_2_int_to_server, adimi_tool_server_event,adimi_tool_total_fix,":player_no"),
            (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
          (try_end),
		(else_try),
          (eq, "$g_multiplayer_players_list_action_type", 20),
          (multiplayer_send_2_int_to_server, adimi_tool_streamer_tool_server_side, enl_event_toggle_streamer, ":player_no"),
          (start_presentation, "prsnt_multiplayer_show_players_list"),#restart the presentation (perhaps the admin wants to select more players)
        (try_end),
        (try_end),
		(eq,":continue",1),
        ...
        (presentation_set_duration, 0),
      (try_end),
      (try_begin),#Selector 0 or 1
       (eq,":object","$adimi_tool_player_list_0_or_1"),
       (assign,"$adimi_tool_show_players_0_or_1",":value"),
	    (try_begin),#Teleport avoid all button for tp me to all!?
	     (eq, "$g_multiplayer_players_list_action_type", 16),
	     (eq,"$adimi_tool_show_players_0_or_1",1),
		 (assign, "$g_multiplayer_players_list_action_type", 17),
	     (presentation_set_duration, 0),
	     (start_presentation, "prsnt_multiplayer_show_players_list"),
		(else_try),#Teleport avoid all button for tp me to all!?
		 (eq, "$g_multiplayer_players_list_action_type", 17),
	     (eq,"$adimi_tool_show_players_0_or_1",0),
		 (assign, "$g_multiplayer_players_list_action_type", 16),
	     (presentation_set_duration, 0),
	     (start_presentation, "prsnt_multiplayer_show_players_list"),
        (try_end),
      (try_end),
      (try_begin),#Set Gold|Set HP
       (eq,":object","$g_presentation_adimi_set_value_bar"),
       (try_begin),
        (eq, "$g_multiplayer_players_list_action_type", 8),#HitPoints
        (assign,"$adimi_tool_set_hp",":value"),
       (else_try),
        (eq, "$g_multiplayer_players_list_action_type", 10),#Gold
        (assign,"$adimi_tool_set_gold",":value"),
       (try_end),
      (try_end),
	  (try_begin),
	    (eq,":object", "$adimi_tool_player_punishment_reason"),
		(assign,"$adimi_tool_player_punishment_reason_number",":value"),
	  (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
    ...
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      (try_begin),
       ...
       (create_text_overlay, reg0, "str_adimi_poll_menu", 0),
       (overlay_set_color, reg0, 0xFFFFFF),
       (position_set_x, pos1, 860),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, reg0, pos1),
       (val_sub, ":cur_y", 1*escape_menu_item_height),
       
       (create_text_overlay, reg0, "str_adimi_poll_info_menu", 0),
       (overlay_set_color, reg0, 0xFFFFFF),
       (position_set_x, pos1, 860),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, reg0, pos1),
       (val_sub, ":cur_y", 2*escape_menu_item_height),
       
       (create_text_overlay, reg0, "str_adimi_poll_menu_accept_poll", 0),
       (overlay_set_color, reg0, green),
       (position_set_x, pos1, 860),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, reg0, pos1),
       (val_sub, ":cur_y", escape_menu_item_height),
       
       (create_text_overlay, reg0, "str_adimi_poll_menu_reject_poll", 0),
       (overlay_set_color, reg0, red),
       (position_set_x, pos1, 860),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, reg0, pos1),
       (val_sub, ":cur_y", escape_menu_item_height),
       
       (create_text_overlay, reg0, "str_adimi_poll_menu_close_poll", 0),
       (overlay_set_color, reg0, white),
       (position_set_x, pos1, 860),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, reg0, pos1),
       (val_sub, ":cur_y", escape_menu_item_height),
    ...
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
      ...
      (else_try),
        ...
        (presentation_set_duration, 0),
      (else_try),
		(key_clicked, key_f5),#ACCEPT
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_low,1),
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_high,1),
        (player_is_admin, ":p"),
        (gt, ":cur_time", 500),
        (multiplayer_send_2_int_to_server, adimi_tool_server_event, adimi_tool_admin_set_poll, 1),
        (clear_omitted_keys),
        (presentation_set_duration, 0),
      (else_try),
		(key_clicked, key_f6),#REJECT
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_low,1),
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":p",adimi_tool_admin_level_high,1),
        (player_is_admin, ":p"),
        (gt, ":cur_time", 500),
        (multiplayer_send_2_int_to_server, adimi_tool_server_event, adimi_tool_admin_set_poll, 2),
        (clear_omitted_keys),
        (presentation_set_duration, 0),
      (try_end),
      (store_mission_timer_a, ":mission_timer"),
...
##        (gt, ":total_wage", 0),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    #INVASION MODE END
	    ...
	    ("adimi_poll_panel", prsntf_read_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
       ...
       (omit_key_once, key_f6),
       (omit_key_once, key_f7),
      (presentation_set_duration, 6000),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
      (try_begin),
    ...
    ("adimi_chat",prsntf_manual_end_only, 0,[
    (ti_on_presentation_load,
       [
        (set_fixed_point_multiplier, 1000),
        (init_position, pos1),
        
        (create_text_overlay, "$adimi_chat_title", "str_adimi_chat_everyone",tf_with_outline),
        (overlay_set_color, "$adimi_chat_title", dark_red), 
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 530),
        (overlay_set_position, "$adimi_chat_title", pos1),
        (str_store_string, s1, "str_adimi_chat_everyone"),
        (position_set_x, pos1, 1000),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$adimi_chat_title", pos1),

        (create_simple_text_box_overlay, "$adimi_chat_box", tf_center_justify),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$adimi_chat_box", pos1),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$adimi_chat_box", pos1),
        
        (presentation_set_duration, 999999),
        (assign,"$adimi_tool_admin_send_message", 0),
        (assign,"$adimi_tool_admin_message_tip_rdy", 0),
      ]),

      (ti_on_presentation_event_state_change,
              [(store_trigger_param_1, ":object"),
              (try_begin),
                  (eq,"$adimi_chat_box",":object"),
                  (try_begin),
                    (eq,"$adimi_tool_admin_send_message", 1),
                    (neg|str_is_empty, s0),
                    (multiplayer_send_string_to_server, adimi_tool_server_event, s0),
                    (multiplayer_send_int_to_server, adimi_tool_server_event, adimi_tool_chat),
                  (try_end),
                  (presentation_set_duration, 0),
                  (assign,"$adimi_tool_admin_send_message", -1),
                  (assign,"$adimi_tool_admin_message_tip_rdy", -1),
              (try_end),
        ]),

       (ti_on_presentation_run,
           [
           (store_trigger_param,":time",1),
           (try_begin),
                 (key_clicked, key_escape),
                 (presentation_set_duration, 0),
           (try_end),
           (try_begin),
                 (eq,"$adimi_tool_admin_message_tip_rdy", 0),
                 (gt, ":time",20),
                 (overlay_obtain_focus, "$adimi_chat_box"),
                 (str_clear, s0),
                 (overlay_set_text, "$adimi_chat_box", s0),
                 (assign,"$adimi_tool_admin_message_tip_rdy",1),
           (try_end),
           (try_begin),
    ...
    ("adimi_admin_chat",prsntf_manual_end_only, 0,[
    (ti_on_presentation_load,
       [
        (set_fixed_point_multiplier, 1000),
        (init_position, pos1),
        
        (create_text_overlay, "$adimi_chat_title", "str_adimi_chat_admin",tf_with_outline),
        (overlay_set_color, "$adimi_chat_title", dark_red), 
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 530),
        (overlay_set_position, "$adimi_chat_title", pos1),
        ...
        (create_simple_text_box_overlay, "$adimi_admin_chat_box", tf_center_justify),
        (position_set_x, pos1, 200),
        (position_set_y, pos1, 500),
        (overlay_set_position, "$adimi_admin_chat_box", pos1),
        (position_set_x, pos1, 600),
        (position_set_y, pos1, 1000),
        (overlay_set_size, "$adimi_admin_chat_box", pos1),
      ...
      (ti_on_presentation_event_state_change,
              [(store_trigger_param_1, ":object"),
              (try_begin),
                  (eq,"$adimi_admin_chat_box",":object"),
                  (try_begin),
                    (eq,"$adimi_tool_admin_send_message", 1),
                    (neg|str_is_empty, s0),
                    (multiplayer_send_string_to_server, adimi_tool_server_event, s0),
                    (multiplayer_send_int_to_server, adimi_tool_server_event, adimi_tool_admin_chat),
                  (try_end),
                  (presentation_set_duration, 0),
                  (assign,"$adimi_tool_admin_send_message", -1),
                  (assign,"$adimi_tool_admin_message_tip_rdy", -1),
       ...
       (ti_on_presentation_run,
           ...
           (try_begin), 
                 (eq,"$adimi_tool_admin_message_tip_rdy", 0),
                 (gt, ":time",20),
                 (overlay_obtain_focus, "$adimi_admin_chat_box"),
                 (str_clear, s0),
                 (overlay_set_text, "$adimi_admin_chat_box", s0),
                 (assign,"$adimi_tool_admin_message_tip_rdy", 1),
           (try_end),
           (try_begin),
                 (key_clicked, key_enter),
    ...
    ("adimi_features", prsntf_manual_end_only, 0, [
    (ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
        ...
        (assign, "$g_presentation_adimi_spawn_player", -1),
        (assign, "$g_presentation_adimi_gold_a_player", -1),
        (assign, "$g_presentation_adimi_immortal", -1),
        (assign, "$g_presentation_adimi_mute", -1),
        (assign, "$g_presentation_adimi_hp_a_player", -1),
        (assign, "$g_presentation_adimi_slay_a_player", -1),
        (assign, "$g_presentation_adimi_gameid", -1),
        (assign, "$g_presentation_adimi_restore_ammo_shield", -1),
        (assign, "$g_presentation_adimi_slay_bots", -1),
        (assign, "$g_presentation_adimi_slay_horses", -1),
        (assign, "$g_presentation_adimi_switch_teams", -1),
        (assign, "$g_presentation_adimi_teleport", -1),
        (assign, "$g_presentation_adimi_freeze", -1),
        (assign, "$g_presentation_adimi_force_autobalance", -1),
        (assign, "$g_presentation_adimi_spawn_mof", -1),
        (assign, "$g_presentation_adimi_streamer", -1),
        ...
        (create_text_overlay, reg0, "str_adimi", 0),
        (overlay_set_color, reg0, 0xB40404),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, reg0, pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
        (multiplayer_get_my_player,":admin_player_id"),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_spawn_player", "str_adimi_tool_spawn_for_a_player", 0),#Spwan item player
        (overlay_set_color, "$g_presentation_adimi_spawn_player", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_spawn_player", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_gold_a_player", "str_adimi_tool_prsnt_gold_a_player", 0),#Set gold for a player
        (overlay_set_color, "$g_presentation_adimi_gold_a_player", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_gold_a_player", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_immortal", "str_prsnt_for_god_00", 0),#Set players immortal/mortal
        (overlay_set_color, "$g_presentation_adimi_immortal", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_immortal", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    ...
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_mute", "str_prsnt_for_mute_00", 0),#Mute unmute
        (overlay_set_color, "$g_presentation_adimi_mute", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_mute", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_hp_a_player", "str_adimi_tool_prsnt_hp_a_player", 0),#Set HP for a player
        (overlay_set_color, "$g_presentation_adimi_hp_a_player", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_hp_a_player", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_slay_a_player", "str_adimi_tool_prsnt_slay_a_player", 0),#Slay a player
        (overlay_set_color, "$g_presentation_adimi_slay_a_player", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_slay_a_player", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_low,1),
	    ...
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
        (create_button_overlay, "$g_presentation_adimi_gameid", "str_adimi_tool_prsnt_gameid", 0),#Print GAMEID
        (overlay_set_color, "$g_presentation_adimi_gameid", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_gameid", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_restore_ammo_shield", "str_prsnt_for_ammoshield_03", 0),#Restore ammo heal shield
        (overlay_set_color, "$g_presentation_adimi_restore_ammo_shield", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_restore_ammo_shield", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_slay_bots", "str_prsnt_for_slay_02", 0),#Slay all bots
        (overlay_set_color, "$g_presentation_adimi_slay_bots", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_slay_bots", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_slay_horses", "str_prsnt_for_slay_03", 0),#Slay all horses
        (overlay_set_color, "$g_presentation_adimi_slay_horses", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_slay_horses", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_switch_teams", "str_prsnt_for_team_switch", 0),#Team switch
        (overlay_set_color, "$g_presentation_adimi_switch_teams", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_switch_teams", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_teleport", "str_prsnt_for_teleport_3", 0),#Teleport
        (overlay_set_color, "$g_presentation_adimi_teleport", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_teleport", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
	(try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_mid,1),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_freeze", "str_prsnt_for_freeze", 0),#freeze
        (overlay_set_color, "$g_presentation_adimi_freeze", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_freeze", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
	(try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_total_fix", "str_prsnt_for_total_fix", 0),#freeze
        (overlay_set_color, "$g_presentation_adimi_total_fix", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_total_fix", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
	(try_begin),
	    (neq, "$g_multiplayer_game_type", multiplayer_game_type_deathmatch),
	    ...
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_force_autobalance", "str_adimi_tool_force_teamautobalance", 0),#Force teamautobalance
        (overlay_set_color, "$g_presentation_adimi_force_autobalance", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_force_autobalance", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
	(try_begin),
	    (eq, "$g_multiplayer_game_type", multiplayer_game_type_battle),
	    ...
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_spawn_mof", "str_adimi_tool_spawn_mof", 0),#Spawn MoF
        (overlay_set_color, "$g_presentation_adimi_spawn_mof", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_spawn_mof", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
    (try_begin),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_streamer", "str_prsnt_streamer", 0),#Streamer
        (overlay_set_color, "$g_presentation_adimi_streamer", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_streamer", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
	(try_begin),
	    (this_or_next|player_slot_eq,":admin_player_id",adimi_tool_admin_level_high,1),
        (player_is_admin, ":admin_player_id"),
		(create_button_overlay, "$g_presentation_adimi_reset_map", "str_prsnt_for_reset_map", 0),#ResetMap
        (overlay_set_color, "$g_presentation_adimi_reset_map", white),
        (position_set_y, pos1, ":cur_y"),
        (overlay_set_position, "$g_presentation_adimi_reset_map", pos1),
        (val_sub, ":cur_y", escape_menu_item_height),
    (try_end),
		(try_begin),
	      (multiplayer_get_my_player,":p"),
          (player_is_admin, ":p"),
		  (call_script,"script_adimi_tool_box_right_side_on_load"),
		(try_end),
        (presentation_set_duration, 999999),
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (store_trigger_param_2, ":value"),
      (try_begin),
        (eq, ":object", "$g_presentation_adimi_spawn_player"),#Spawn Menu
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 11),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq,":object","$g_presentation_adimi_gold_a_player"),#Set Gold Button
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 10), #Set Gold
        (start_presentation, "prsnt_multiplayer_show_players_list"),   
      (else_try),
        (eq,":object","$g_presentation_adimi_immortal"),#Set players immortal/mortal
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 12),#Set players immortal/mortal
        (start_presentation, "prsnt_multiplayer_show_players_list"),  
      (else_try),
        (eq,":object","$g_presentation_adimi_mute"),#mute unmute
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 7),#mute unmute
        (start_presentation, "prsnt_multiplayer_show_players_list"),    
      (else_try),
        (eq, ":object", "$g_presentation_adimi_hp_a_player"),#Set HP a player
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 8),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_adimi_slay_a_player"),#Slay a player
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 9),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_adimi_gameid"),#Print GameID
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 13),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_restore_ammo_shield"),#Refill ammo and heal shield
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 14),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_freeze"),#freeze
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 18),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_total_fix"),#Total fix
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 19),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_streamer"),#Streamer
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 20),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
      (else_try),
        (eq, ":object", "$g_presentation_adimi_slay_bots"),#slay bots
        (presentation_set_duration, 0),
        (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_slay_bots),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_slay_horses"),#Slay horse
        (presentation_set_duration, 0),
        (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_slay_horse),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_switch_teams"),#Switch Team
        (presentation_set_duration, 0),
        (assign, "$g_multiplayer_players_list_action_type", 15),
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_teleport"),#Teleport
        (presentation_set_duration, 0),
		(try_begin),#Reset "$adimi_tool_player_list_0_or_1" if it is invalid
		  (neg|is_between,"$adimi_tool_show_players_0_or_1",0,2),
		  (assign,"$adimi_tool_show_players_0_or_1",0),
		(try_end),
		(assign, "$g_multiplayer_players_list_action_type", 16),#default
		(try_begin),
		  (eq,"$adimi_tool_show_players_0_or_1",0),
		  (assign, "$g_multiplayer_players_list_action_type", 16),
		(else_try),
        ...
        (start_presentation, "prsnt_multiplayer_show_players_list"),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_force_autobalance"),#Force autobalance
        (presentation_set_duration, 0),
        (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_force_teambalance),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_spawn_mof"),#Spawn master of the field flag
        (presentation_set_duration, 0),
        (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_spawn_mof),
	  (else_try),
        (eq, ":object", "$g_presentation_adimi_reset_map"),#Reset Map
        (presentation_set_duration, 0),
        (multiplayer_send_int_to_server, adimi_tool_server_all_event, adimi_tool_request_map_reset),
      (try_end),

	  (try_begin),
	    (multiplayer_get_my_player,":p"),
        (player_is_admin, ":p"),
	    (call_script,"script_adimi_tool_box_right_side_state_change",":object",":value"),
	  (try_end),
      ]),
    (ti_on_presentation_run,
     [(store_trigger_param_1, ":cur_time"),
	  ...
	  (try_begin),
	    (multiplayer_get_my_player,":p"),
        (player_is_admin, ":p"),
	    (call_script,"script_adimi_tool_box_right_side_prsnt_run",":cur_time"),
	  (try_end),
      ]),
    ]),
    
#########thanks to rubik 
#http://forums.taleworlds.com/index.php/topic,130384.0.html 
#for the open source stuff
     ("adimi_tool_spawn_items",prsntf_manual_end_only,0, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
     ...
     #   (overlay_add_item, "$g_presentation_obj_1", "@Other"),
        ...
        (eq,"$temp",2),
          (create_game_button_overlay, "$g_presentation_obj_7", "str_adimi_tool_choose_player"),
          (position_set_x, pos1, 880),
          (position_set_y, pos1, 675),
    ...
    (try_begin),#NOT USED
       (set_container_overlay, -1),
       (eq, "$temp", 3),
       (assign,"$adimi_tool_set_gold",1000),
       (assign, ":cur_y", 575),
       (position_set_x, pos1, 80),
       
       (create_number_box_overlay, "$g_presentation_adimi_set_gold_bar", 0, 100001), #returns overlay id
       (overlay_set_val, "$g_presentation_adimi_set_gold_bar", "$adimi_tool_set_gold"),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, "$g_presentation_adimi_set_gold_bar", pos1),
       (val_sub, ":cur_y", escape_menu_item_height),
        
       (assign, ":cur_y", 600), 
       (position_set_x, pos1, 150),
       (create_button_overlay, "$g_presentation_adimi_gold_a_player", "str_adimi_tool_prsnt_gold_a_player", 0),#Set gold for a player
       (overlay_set_color, "$g_presentation_adimi_gold_a_player", black),
       (position_set_y, pos1, ":cur_y"),
       (overlay_set_position, "$g_presentation_adimi_gold_a_player", pos1),
       (val_sub, ":cur_y", escape_menu_item_height),
    ...
    (ti_on_presentation_event_state_change,
      [
        ...
        (else_try),
          ...
          (presentation_set_duration, 0),
          (assign,"$adimi_tool_for_a_player",0),
        (else_try),
          ...
          (assign, "$g_multiplayer_players_list_action_type", 11),          
        (else_try),
          (this_or_next|eq, "$temp", 0),#Item spawning
          (eq, "$temp", 1),
          (eq,"$adimi_tool_for_a_player",2),
          (neq,":object","$g_presentation_obj_1"),
          (neq,":object","$g_presentation_obj_5"),
          (try_begin),
          (eq,"$adimi_tool_spawn_selected_player_id",50000),
          (try_for_range, ":slot_no", 0, "$temp_2"),
            (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
            (troop_get_slot, ":item_no", "trp_temp_array_c", ":slot_no"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event, adimi_tool_spawn_item,":item_no"),#Spawn item for everyone                   
          (try_end),
          (else_try),
           (display_message,"str_adimi_tool_select_a_player_warning"),
          (try_end),
        (else_try),
          (eq, "$temp", 2),#Horse Spawning
          (neq,":object","$g_presentation_obj_1"),
          (neq,":object","$g_presentation_obj_5"),
          (eq,"$adimi_tool_for_a_player",2),
          (try_begin),
          ...
          (try_for_range, ":slot_no", 0, "$temp_2"),
            (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
            (troop_get_slot, ":item_no", "trp_temp_array_c", ":slot_no"),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event, adimi_tool_spawn_horse,":item_no"),#Spawn Horse for everyone                   
          (try_end),
          (else_try),
           (display_message,"str_adimi_tool_select_a_player_warning"),
          (try_end), 
        (else_try),
          (this_or_next|eq, "$temp", 0),#Item spawning for A PLAYER
          (eq, "$temp", 1),
          (neq,":object","$g_presentation_obj_1"),
          (neq,":object","$g_presentation_obj_5"),
          (eq,"$adimi_tool_for_a_player",1),
          (try_begin),
         # (player_is_active,"$adimi_tool_spawn_selected_player_id"),
		  (neq,"$adimi_tool_spawn_selected_player_id",-1),
          (try_for_range, ":slot_no", 0, "$temp_2"),
            (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
            (troop_get_slot, ":item_no", "trp_temp_array_c", ":slot_no"),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_spawn_item,"$adimi_tool_spawn_selected_player_id",":item_no"),#Spawn item for everyone                   
          (try_end),
          (else_try),
           (display_message,"str_adimi_tool_select_a_player_warning"),
          (try_end),
        (else_try),
          (eq, "$temp", 2),#Horse Spawning for A PLAYER
          (neq,":object","$g_presentation_obj_1"),
          (neq,":object","$g_presentation_obj_5"),
          (eq,"$adimi_tool_for_a_player",1),
          (try_begin),
         # (player_is_active,"$adimi_tool_spawn_selected_player_id"),
          ...
          (try_for_range, ":slot_no", 0, "$temp_2"),
            (troop_slot_eq, "trp_temp_array_a", ":slot_no", ":object"),
            (troop_get_slot, ":item_no", "trp_temp_array_c", ":slot_no"),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_spawn_horse,"$adimi_tool_spawn_selected_player_id",":item_no"),#Spawn Horse for a player                   
          (try_end),
          (else_try),
           (display_message,"str_adimi_tool_select_a_player_warning"),
          (try_end),
        (else_try),#NOT USED
          (eq, "$temp", 3),#Other Stuff (Gold ....)
          (neq,":object","$g_presentation_obj_1"),
          (neq,":object","$g_presentation_obj_5"),
          (try_begin),
           (eq, ":object", "$g_presentation_adimi_set_gold_bar"),#Set Gold bar
           (assign,"$adimi_tool_set_gold",":value"),
          (else_try),
           (eq,":object","$g_presentation_adimi_gold_a_player"),
           (eq,"$adimi_tool_for_a_player",1),
           (try_begin),
           # (player_is_active,"$adimi_tool_spawn_selected_player_id"),
		    (neq,"$adimi_tool_spawn_selected_player_id",-1),
            (multiplayer_send_3_int_to_server, adimi_tool_server_event, adimi_tool_gold,"$adimi_tool_spawn_selected_player_id","$adimi_tool_set_gold"),
           (else_try),
            (eq,"$adimi_tool_spawn_selected_player_id",50000),
            (multiplayer_send_2_int_to_server, adimi_tool_server_all_event, adimi_tool_gold,"$adimi_tool_set_gold"),
           (try_end),            
    ...
    (ti_on_presentation_run,
      [
        ...
        (try_begin),
          (eq,"$adimi_tool_spawn_selected_player_id",50000),
          (overlay_set_text, "$g_presentation_obj_7", "str_adimi_tool_choose_player_everyone"),
        (else_try),
          (player_is_active,"$adimi_tool_spawn_selected_player_id"),
          (str_store_player_username,s1,"$adimi_tool_spawn_selected_player_id"),
          (overlay_set_text, "$g_presentation_obj_7", "str_adimi_tool_choose_player_choosen"),
        (else_try),
          (overlay_set_text, "$g_presentation_obj_7", "str_adimi_tool_choose_player"),
          (assign,"$adimi_tool_spawn_selected_player_id",-1),
        (try_end),
        (try_end),
		(try_begin),
    ...
    ("admin_level_pin",prsntf_manual_end_only,0, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
		
		(assign, "$adimi_tools_pin_field", -1),
		(assign, "$adimi_tools_pin", 0),
        ...
        (create_text_overlay, reg0, "str_adimi_tool_pin"),
		(position_set_x, pos1, 470),
        (position_set_y, pos1, 650),
        (overlay_set_position, reg0, pos1),
		(overlay_set_color, reg0, white),
		
		(create_number_box_overlay, "$adimi_tools_pin_field", 0, 100000), #returns overlay id
		(overlay_set_val, "$adimi_tools_pin_field", "$adimi_tools_pin"),
		(position_set_x, pos1, 480),
        (position_set_y, pos1, 618),
        (overlay_set_position, "$adimi_tools_pin_field", pos1),
		
		(create_button_overlay, "$adimi_tools_send_button", "str_adimi_tool_send_pin"),
		(position_set_x, pos1, 455),
        (position_set_y, pos1, 565),
        (overlay_set_position, "$adimi_tools_send_button", pos1),
		(overlay_set_color, "$adimi_tools_send_button", red),
      ]),
	...
	(ti_on_presentation_event_state_change,
      [
        ...
        (store_trigger_param_2, ":value"),
        (try_begin),
		  (eq,":object","$adimi_tools_pin_field"),
		  (assign,"$adimi_tools_pin",":value"),
		(else_try),
		  (eq,":object","$adimi_tools_send_button"),
		  (multiplayer_send_2_int_to_server, adimi_tool_client_event, adimi_tool_set_admin_level, "$adimi_tools_pin"),
		  (assign,reg0,"$adimi_tools_pin"),
          (display_message,"str_adimi_tool_entered_pin",brown),
          (display_message,"str_adimi_tool_transmitted_pin",yellow),
		  (presentation_set_duration, 0),
		(try_end), 
    ]),
    (ti_on_presentation_run,
  ...
  ("gotha_dev_infos",prsntf_manual_end_only,0, [
    (ti_on_presentation_load,
      [
        (presentation_set_duration, 999999),
        (set_fixed_point_multiplier, 1000),
        (mouse_get_position,pos11), #x and y values of position are filled
		(position_get_x,reg5,pos11),
		(position_get_y,reg6,pos11),
        (create_text_overlay, "$gotha_dev_mouse_position", "@Mouse Pos.| X: {reg1} | Y: {reg2}"),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 700),
        (overlay_set_position, "$gotha_dev_mouse_position", pos1),
		
		
		(create_text_overlay, "$gotha_dev_agent_position", "@My Agent Pos.| X: {reg4} | Y: {reg5} | Z: {reg6}"),
		(position_set_x, pos1, 500),
        (position_set_y, pos1, 680),
        (overlay_set_position, "$gotha_dev_agent_position", pos1),
		(overlay_set_display, "$gotha_dev_agent_position", 0),
		(overlay_set_color, "$gotha_dev_agent_position", white),
		(overlay_set_color, "$gotha_dev_mouse_position", white),
    ...
    (ti_on_presentation_run,
      [
		...
		(position_get_y,reg2,pos11),
        (overlay_set_text, "$gotha_dev_mouse_position", "@Mouse Pos.| X: {reg1} | Y: {reg2}"),
		(set_fixed_point_multiplier, 1000),
        (try_begin),
		  ...
		  (position_get_x,reg4,pos12),
		  (position_get_y,reg5,pos12),
		  (position_get_z,reg6,pos12),
		  (overlay_set_text, "$gotha_dev_agent_position", "@My Agent Pos.| X: {reg4} | Y: {reg5} | Z: {reg6}"),
		  (overlay_set_display, "$gotha_dev_agent_position", 1),
		(else_try),
		  (overlay_set_display, "$gotha_dev_agent_position", 0),
        (try_end),
		...
		(try_begin),
          ...
          (position_get_x,reg1,pos11),
	      (position_get_y,reg2,pos11),
          (display_message,"@'Click'!: X: {reg1} | Y: {reg2}"),
		  ##add blue dots per click
		  (create_mesh_overlay, reg1, "mesh_white_dot"),
		  (overlay_set_position, reg1, pos11),
          (position_set_x, pos1, 400),
          (position_set_y, pos1, 400),
          (overlay_set_size, reg1, pos1),
		  (overlay_set_color, reg1, blue),
		(else_try),
		  (key_clicked,key_right_mouse_button),
		  (mouse_get_position,pos11), #x and y values of position are filled
          (position_get_x,reg1,pos11),
	      (position_get_y,reg2,pos11),
          (display_message,"@'Click'!: X: {reg1} | Y: {reg2}"),
		  ##add red dots per click
		  (create_mesh_overlay, reg1, "mesh_white_dot"),
		  (overlay_set_position, reg1, pos11),
          (position_set_x, pos1, 400),
          (position_set_y, pos1, 400),
          (overlay_set_size, reg1, pos1),
		  (overlay_set_color, reg1, red),
		(try_end),
		(try_begin),
		  #reset dots/restart presentation
		  (key_clicked,key_middle_mouse_button),
		  (presentation_set_duration, 0),
          (display_message,"@Reset Dots!"),
		(try_end),
		(try_begin),
		 (neq,"$gotha_dev_mode",2),
		 (presentation_set_duration, 0),
		(try_end),
    ]),
  ]),
	...
	("adimi_player_stats",prsntf_manual_end_only|prsntf_read_only,0, [
    (ti_on_presentation_load,
    [
		(presentation_set_duration, 999999),
		(set_fixed_point_multiplier, 1000),
		(assign,"$adimi_tool_player_stats_text1",0),
		(assign,"$adimi_tool_player_stats_text2",0),
		(assign,"$adimi_tool_player_stats_text3",0),
		(assign,"$adimi_tool_player_stats_text4",0),
		(assign,"$adimi_tool_player_stats_text5",0),
		(assign,"$adimi_tool_player_stats_text6",0),
		...
		#(position_set_y, pos1, 150),
		(overlay_set_position, reg0, pos1),
		(position_set_x, pos1, 6500),
		(position_set_y, pos1, 5600),
		#(position_set_x, pos1, 510),
		#(position_set_y, pos1, 280),
		(overlay_set_size, reg0, pos1),
		(overlay_set_color, reg0, 0x848484),
		...
		(create_text_overlay, "$adimi_tool_player_stats_text1", "str_empty_string", 0),#hitpoints/healthpoints
		(overlay_set_color, "$adimi_tool_player_stats_text1", 0x000000),
		(position_set_x, pos1, 850),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text1", pos1),
		(position_set_x, pos1, 800),
		(position_set_y, pos1, 800),
		(overlay_set_size, "$adimi_tool_player_stats_text1", pos1),
		(val_sub, ":cur_y", 20),
		
		(create_text_overlay, "$adimi_tool_player_stats_text2", "str_empty_string", 0),#kills
		(overlay_set_color, "$adimi_tool_player_stats_text2", 0x000000),
		(position_set_x, pos1, 850),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text2", pos1),
		(position_set_x, pos1, 800),
		(position_set_y, pos1, 800),
		(overlay_set_size, "$adimi_tool_player_stats_text2", pos1),
		(val_sub, ":cur_y", 20),
		
		(create_text_overlay, "$adimi_tool_player_stats_text3", "str_empty_string", 0),#deaths
		(overlay_set_color, "$adimi_tool_player_stats_text3", 0x000000),
		(position_set_x, pos1, 850),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text3", pos1),
		(position_set_x, pos1, 800),
		(position_set_y, pos1, 800),
		(overlay_set_size, "$adimi_tool_player_stats_text3", pos1),
		(val_sub, ":cur_y", 20),
		
		(create_text_overlay, "$adimi_tool_player_stats_text4", "str_empty_string", 0), #KD Ratio neutral,positive,negative
		(overlay_set_color, "$adimi_tool_player_stats_text4", 0x000000),
		(position_set_x, pos1, 850),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text4", pos1),
		(position_set_x, pos1, 800),
		(position_set_y, pos1, 800),
		(overlay_set_size, "$adimi_tool_player_stats_text4", pos1),
		(val_sub, ":cur_y", 20),
		
		(create_text_overlay, "$adimi_tool_player_stats_text5", "str_empty_string", 0),#Ping
		(overlay_set_color, "$adimi_tool_player_stats_text5", 0x000000),
		(position_set_x, pos1, 850),
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text5", pos1),
		(position_set_x, pos1, 600),
		(position_set_y, pos1, 600),
		(overlay_set_size, "$adimi_tool_player_stats_text5", pos1),
		
		(create_text_overlay, "$adimi_tool_player_stats_text6", "str_empty_string", 0), #Ping warning
		(overlay_set_color, "$adimi_tool_player_stats_text6", 0x000000),
		(position_set_x, pos1, 900),#X VALUE IS DIFFERENT !-----------------
		(position_set_y, pos1, ":cur_y"),
		(overlay_set_position, "$adimi_tool_player_stats_text6", pos1),
		(position_set_x, pos1, 600),
		(position_set_y, pos1, 600),
		(overlay_set_size, "$adimi_tool_player_stats_text6", pos1),
		...
		(try_begin),
			(multiplayer_get_my_player,":p"),
			(player_is_active,":p"),
			(player_get_kill_count, reg1, ":p"),
			(player_get_death_count, reg2, ":p"),
			(player_get_ping, reg3, ":p"),
			(get_player_agent_no,":agent"),
			#(player_get_agent_id,":agent",":p"),
			(try_begin),
				(agent_is_active,":agent"),
				(agent_is_alive,":agent"),
				(store_agent_hit_points,reg4,":agent",0),
				(gt,reg4,0),
				(overlay_set_text,"$adimi_tool_player_stats_text1","str_adimi_tool_player_stats_hp"),
			(else_try),
				(player_get_team_no, ":team",":p"),
				(eq,":team",2),
				(overlay_set_text,"$adimi_tool_player_stats_text1","str_adimi_tool_player_stats_yourespec"),
			(else_try),
				(overlay_set_text,"$adimi_tool_player_stats_text1","str_adimi_tool_player_stats_youredead"),
			(try_end),
			(try_begin),
				(eq,reg1,reg2),#ausgeglichener kd
				(overlay_set_text,"$adimi_tool_player_stats_text4","str_adimi_tool_player_stats_kd_neutral"),
				(overlay_set_color, "$adimi_tool_player_stats_text4", yellow),
			(else_try),
				(lt,reg1,reg2),#negativer kd
				(overlay_set_text,"$adimi_tool_player_stats_text4","str_adimi_tool_player_stats_kd_negative"),
				(overlay_set_color, "$adimi_tool_player_stats_text4", red),
			(else_try),
				#positiver kd
				(overlay_set_text,"$adimi_tool_player_stats_text4","str_adimi_tool_player_stats_kd_positive"),
				(overlay_set_color, "$adimi_tool_player_stats_text4", green2),
			(try_end),
			(try_begin),
				(is_between,reg3,85,110),
				(overlay_set_text,"$adimi_tool_player_stats_text6","str_adimi_tool_player_stats_ping_warning1"),
				(overlay_set_color, "$adimi_tool_player_stats_text6", yellow),
			(else_try),
				(ge,reg3,110),
				(overlay_set_text,"$adimi_tool_player_stats_text6","str_adimi_tool_player_stats_ping_warning2"),
				(overlay_set_color, "$adimi_tool_player_stats_text6", red),
			(else_try),
				(overlay_set_text,"$adimi_tool_player_stats_text6","str_empty_string"),
			(try_end),
			(str_store_string,s5,"str_kills"),
			(str_store_string,s6,"str_deaths"),
			(str_store_string,s7,"str_ping"),
			(overlay_set_text,"$adimi_tool_player_stats_text2","str_adimi_tool_player_stats_kills"),
			(overlay_set_text,"$adimi_tool_player_stats_text3","str_adimi_tool_player_stats_deaths"),
			(overlay_set_text,"$adimi_tool_player_stats_text5","str_adimi_tool_player_stats_ping"),
		(try_end),
    ]),
    (ti_on_presentation_run,
    [
	...
	(try_begin),
		...
		#(key_clicked, key_xbox_start),
		(gt, ":cur_time", 500),
		(assign,"$adimi_tool_stats_presentation",0),
		(presentation_set_duration, 0),
	(else_try),
		(multiplayer_get_my_player,":p"),
		(player_is_active,":p"),
