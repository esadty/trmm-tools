...
# Add Extra Quest NPCs below this point  
  ...
  ["hired_assassin","Hired Assassin","Hired Assassin",tf_guarantee_boots|tf_guarantee_armor,0,0,fac_commoners, #they look like belligerent drunks
   [itm_short_tunic,itm_linen_tunic,itm_coarse_tunic, itm_tabard, itm_leather_vest, itm_woolen_hose, itm_nomad_boots, itm_blue_hose, itm_wrapping_boots, itm_fur_hat, itm_leather_cap, itm_sword_viking_1],
  str_15 | agi_15 |def_attrib_multiplayer|level(19),wpe(120,120,120,120),knows_common_multiplayer|knows_ironflesh_3|knows_power_draw_5|knows_power_throw_4|knows_shield_4|knows_power_strike_4|knows_athletics_6|knows_riding_4,    bandit_face1, bandit_face2],
...
#   def_attrib_multiplayer|level(20),wp_melee(100)|wp_crossbow(120),knows_common_multiplayer|knows_riding_4|knows_shield_3|knows_ironflesh_3|knows_horse_archery_2|knows_power_strike_3|knows_athletics_2|knows_shield_2,swadian_face_young_1, swadian_face_old_2],
  ...
  ["join_leave_01","join_leave_01","join_leave_01",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["join_leave_02","join_leave_02","join_leave_02",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_x1","teamkill_stats_x","teamkill_stats_x",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_x2","teamkill_stats_x","teamkill_stats_x",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_01","teamkill_stats_01","teamkill_stats_01",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_02","teamkill_stats_02","teamkill_stats_02",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_03","teamkill_stats_03","teamkill_stats_03",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],     
  ["teamkill_stats_04","teamkill_stats_04","teamkill_stats_04",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],  
  ["admin_level1","admin_level1","admin_level1",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],  
  ["admin_level2","admin_level2","admin_level2",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],  
  ["admin_level3","admin_level3","admin_level3",tf_hero, 0,0, fac_commoners,[],def_attrib|level(2),wp(20),knows_inventory_management_10,0],  
